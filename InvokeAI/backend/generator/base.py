...
#        return o.__dict__  
#class SaveInputs():
##    def __init__(self,model,precision,with_variations,seed,variation_amount,prompt,sampler,width,height,step_callback,threshold,perlin,h_symmetry_time_pct,v_symmetry_time_pct):
...
#        self.precision =copy.copy( precision)
...
#        #self.attention_maps_callback=attention_maps_callback
#    def toJSON(self):
...
class Generator:
    ...
    def generate(
        ...
        **kwargs,
        ...
        #saveInput=SaveInputs(self.model,self.precision,self.with_variations,self.seed,self.variation_amount,prompt,sampler,width,height,step_callback,threshold,perlin,h_symmetry_time_pct,v_symmetry_time_pct)
        #print("************************* saveInput.toJSON() ********************")
        #print(saveInput)
        #f = open("saveInput.txt", "w")
        ##f.write(saveInput.toJSON())
        #f.close()
        #print(MyEncoder().encode(saveInput.model))
        #print(saveInput.toJSON())
        #print("************************* saveInput.toJSON() ********************")
        scope = nullcontext
        ...
        with scope(self.model.device.type):
            for n in trange(iterations, desc="Generating"):
                ...
                results.append([image, seed, attention_maps_images,jsonData])
